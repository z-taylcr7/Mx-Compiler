...
public class MxParser extends Parser {
	...
	public static final int
		...
		ID=55, Literal=56, BoolLiteral=57, IntLiteral=58, StringLiteral=59, NullLiteral=60;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"Break", "Continue", "Return", "WhiteSpace", "NewLine", "ID", "Literal", 
			"BoolLiteral", "IntLiteral", "StringLiteral", "NullLiteral"
		};
	}
