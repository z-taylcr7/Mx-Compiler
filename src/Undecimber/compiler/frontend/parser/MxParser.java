...
public class MxParser extends Parser {
	...
	public final FuncCallArgsContext funcCallArgs() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << Add) | (1L << Minus) | (1L << LogicNegative) | (1L << Negative) | (1L << SelfAdd) | (1L << SelfMinus) | (1L << LParen) | (1L << LambdaStart) | (1L << New) | (1L << This) | (1L << Null) | (1L << True) | (1L << False) | (1L << ID) | (1L << IntLiteral) | (1L << StringLiteral))) != 0)) {
				{
				setState(114);
				expression(0);
				setState(119);
	...
	public final ForStmtContext forStmt() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << Add) | (1L << Minus) | (1L << LogicNegative) | (1L << Negative) | (1L << SelfAdd) | (1L << SelfMinus) | (1L << LParen) | (1L << LambdaStart) | (1L << IntType) | (1L << BoolType) | (1L << StringType) | (1L << VoidType) | (1L << New) | (1L << This) | (1L << Null) | (1L << True) | (1L << False) | (1L << ID) | (1L << IntLiteral) | (1L << StringLiteral))) != 0)) {
				{
				setState(195);
				forInit();
				}
