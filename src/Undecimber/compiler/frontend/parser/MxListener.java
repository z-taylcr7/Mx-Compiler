...
public interface MxListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code locallambdaExp}
	 * labeled alternative in {@link MxParser#expression}.
	 * @param ctx the parse tree
	 */
	void enterLocallambdaExp(MxParser.LocallambdaExpContext ctx);
	/**
	 * Exit a parse tree produced by the {@code locallambdaExp}
	 * labeled alternative in {@link MxParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitLocallambdaExp(MxParser.LocallambdaExpContext ctx);
	/**
