...
public class RV32I {
    ...
    public static final ArrayList<String> RegList = new ArrayList<String>(Arrays.asList(
    ...
    public static final String ByteWord = "b";
    public static final String HalfWord = "h";
    public static final String WordWord = "w";
